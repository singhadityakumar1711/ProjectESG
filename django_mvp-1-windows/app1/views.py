...
def extract_unique_page_numbers(text):
    # Define the regular expression pattern to match the page numbers
    ...
    unique_page_numbers = list(set(int(match) for match in matches))

    # Return the sorted list of unique page numbers
    return sorted(unique_page_numbers)
...
prompts_desc = [
    "Critically analyze the contribution in the field of Bribery & Corruption. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies eradicating Bribery & Corruption 2. Look thogroughly and strictly whether the company has identified the impacts of Bribery & Corruption on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Bribery & Corruption.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Training on principles. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Training on principles 2. Look thogroughly and strictly whether the company has identified the impacts of Training on principles on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Training on principles.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Transparency & disclosure in ethical, transparent manner. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Transparency & disclosure in ethical, transparent manner 2. Look thogroughly and strictly whether the company has identified the impacts of Transparency & disclosure in ethical, transparent manner on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Transparency & disclosure in ethical, transparent manner.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of R&D and capital expenditure. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting R&D and capital expenditure 2. Look thogroughly and strictly whether the company has identified the impacts of R&D and capital expenditure on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to R&D and capital expenditure.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Input material and sourcing. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Input material and sourcing 2. Look thogroughly and strictly whether the company has identified the impacts of Input material and sourcing on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Input material and sourcing.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Usage of recycled or reused inputs. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Usage of recycled or reused inputs 2. Look thogroughly and strictly whether the company has identified the impacts of Usage of recycled or reused inputs on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Usage of recycled or reused inputs.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Well being of employees and workmen. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Well being of employees and workmen 2. Look thogroughly and strictly whether the company has identified the impacts of Well being of employees and workmen on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Well being of employees and workmen.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Details of trainings given to employees. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies towards Details of trainings given to employees 2. Look thogroughly and strictly whether the company has identified the impacts of Details of trainings given to employees on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Details of trainings given to employees.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Membership of employees in unions/ associations. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Membership of employees in unions/ associations 2. Look thogroughly and strictly whether the company has identified the impacts of Membership of employees in unions/ associations on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Membership of employees in unions/ associations.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Protection of stakeholder's interest. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Protection of stakeholder's interest 2. Look thogroughly and strictly whether the company has identified the impacts of Protection of stakeholder's interest on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Protection of stakeholder's interest.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Protection of Human rights. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Protection of Human rights 2. Look thogroughly and strictly whether the company has identified the impacts of protection of Human rights on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to protection of Human rights.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Details of salary/wages, minimum wages policy. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Details of salary/wages, minimum wages policy 2. Look thogroughly and strictly whether the company has identified the impacts of Details of salary/wages, minimum wages policy on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Details of salary/wages, minimum wages policy.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of grievances related to human rights issues such as child labor, sexual harassment etc. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies minimizing grievances related to human rights issues such as child labor, sexual harassment etc 2. Look thogroughly and strictly whether the company has identified the impacts of grievances related to human rights issues such as child labor, sexual harassment etc on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to grievances related to human rights issues such as child labor, sexual harassment etc.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Total Energy/ Electricity consumption. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies towards Total Energy/ Electricity consumption 2. Look thogroughly and strictly whether the company has identified the impacts of Total Energy/ Electricity consumption on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Total Energy/ Electricity consumption.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Water and Effluents disclosure. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies towards Water and Effluents disclosure 2. Look thogroughly and strictly whether the company has identified the impacts of Water and Effluents disclosure on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Water and Effluents disclosure.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of GHG Emissions. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies minimizing GHG Emissions 2. Look thogroughly and strictly whether the company has identified the impacts of GHG Emissions on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to GHG Emissions.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Waste, e-waste related disclosure. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies towards Waste, e-waste related disclosure 2. Look thogroughly and strictly whether the company has identified the impacts of Waste, e-waste related disclosure on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Waste, e-waste related disclosure.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Biodiversity. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Biodiversity 2. Look thogroughly and strictly whether the company has identified the impacts of Biodiversity on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to promoting Biodiversity.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Environmental impact assessments. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Environmental impact assessments 2. Look thogroughly and strictly whether the company has identified the impacts of Environmental impact assessments on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Environmental impact assessments.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Affiliation with association and industry chambers. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Affiliation with association and industry chambers 2. Look thogroughly and strictly whether the company has identified the impacts of Affiliation with association and industry chambers on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Affiliation with association and industry chambers.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of CSR beneficiaries. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting CSR beneficiaries 2. Look thogroughly and strictly whether the company has identified the impacts of CSR beneficiaries on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to CSR beneficiaries.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Input material procurement. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies towards Input material procurement 2. Look thogroughly and strictly whether the company has identified the impacts of Input material procurement on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Input material procurement. Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Responding to consumer complaints and feedback. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Responding to consumer complaints and feedback 2. Look thogroughly and strictly whether the company has identified the impacts of Responding to consumer complaints and feedback on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Responding to consumer complaints and feedback.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Marketing and Labeling. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Marketing and Labeling 2. Look thogroughly and strictly whether the company has identified the impacts of Marketing and Labeling on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Marketing and Labeling.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
    "Critically analyze the contribution in the field of Customer Privacy. There are three metrics to analyze -1. Look thogroughly and strictly whether the company has alligned their policies promoting Customer Privacy 2. Look thogroughly and strictly whether the company has identified the impacts of Customer Privacy on operations 3. Look thogroughly and strictly whether the company has tracked the implementation and effectiveness of actions taken in response to Customer Privacy.Be strict when providing scores to the metrics. Justify the score in bullet points briefly. Page number after each bullet point",
]
...
def summarize_main(temp_dir):
    ...
    if temp_dir is not None:
        ...
        summarized_response = {
            "Environmental": {
                "Water Sustainibilty": {
                    "content": res_parse(responses[0]),
                    "pages": extract_unique_page_numbers(responses[0]),
                },
                "Waste Management": {
                    "content": res_parse(responses[1]),
                    "pages": extract_unique_page_numbers(responses[1]),
                },
                "Climate Commitments": {
                    "content": res_parse(responses[2]),
                    "pages": extract_unique_page_numbers(responses[2]),
                },
            },
            "Social": {
                "Employee wellness, Health & Safety": {
                    "content": res_parse(responses[3]),
                    "pages": extract_unique_page_numbers(responses[3]),
                },
                "Diversity & Inclusion": {
                    "content": res_parse(responses[4]),
                    "pages": extract_unique_page_numbers(responses[4]),
                },
                "Human Rights": {
                    "content": res_parse(responses[5]),
                    "pages": extract_unique_page_numbers(responses[5]),
                },
            },
            "Governance": {
                "Corporate Governance": {
                    "content": res_parse(responses[6]),
                    "pages": extract_unique_page_numbers(responses[6]),
                },
            },
        }
...
def ai_summarized(request):
    if request.method == "POST" and "pdf_id" in request.POST:
        ...
        mapping_file_path = os.path.join(
            settings.BASE_DIR, "public", "pdf_mappings.json"
        )
        with open(mapping_file_path, "r") as mapping_file:
            data = json.load(mapping_file)
            # uploaded_file = data.get(pdf_id, None)
            for top_key in data:
                if pdf_id in data[top_key]:
                    uploaded_file = data[top_key][pdf_id]
...
def assessment_main(temp_dir):
    if temp_dir is not None:
        ...
        loop = 0
        justification = []
        for prompt in prompts_desc:
            justification.append(get_answer(prompts_desc[loop], index))
            loop = loop + 1
        ai_checklist = [
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[0]),
                        "pages": extract_unique_page_numbers(justification[0]),
                    },
                    {
                        "ind": "Training on principles",
                        "gri": "GRI 2-17",
                        "assessment": comment[1],
                        "justification": res_parse(justification[1]),
                        "pages": extract_unique_page_numbers(justification[1]),
                    },
                    {
                        "ind": "Transparency & disclosure",
                        "gri": "GRI 2-17",
                        "assessment": comment[2],
                        "justification": res_parse(justification[2]),
                        "pages": extract_unique_page_numbers(justification[2]),
                    },
                ],
            },
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[3]),
                        "pages": extract_unique_page_numbers(justification[3]),
                    },
                    {
                        "ind": "Input material and sourcing",
                        "gri": "GRI 308-1",
                        "assessment": comment[4],
                        "justification": res_parse(justification[4]),
                        "pages": extract_unique_page_numbers(justification[4]),
                    },
                    {
                        "ind": "Usage of recycled or reused inputs",
                        "gri": "GRI 306-2",
                        "assessment": comment[5],
                        "justification": res_parse(justification[5]),
                        "pages": extract_unique_page_numbers(justification[5]),
                    },
                ],
            },
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[6]),
                        "pages": extract_unique_page_numbers(justification[6]),
                    },
                    {
                        "ind": "Details of trainings given to employees",
                        "gri": "GRI 404-1",
                        "assessment": comment[7],
                        "justification": res_parse(justification[7]),
                        "pages": extract_unique_page_numbers(justification[7]),
                    },
                    {
                        "ind": "Membership of employees in unions/ associations",
                        "gri": "GRI 2-30",
                        "assessment": comment[8],
                        "justification": res_parse(justification[8]),
                        "pages": extract_unique_page_numbers(justification[8]),
                    },
                ],
            },
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[9]),
                        "pages": extract_unique_page_numbers(justification[9]),
                    },
                ],
            },
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[10]),
                        "pages": extract_unique_page_numbers(justification[10]),
                    },
                    {
                        "ind": "Details of salary/wages, minimum wages policy",
                        "gri": "GRI 2-19, GRI 2-21, GRI 405-2",
                        "assessment": comment[11],
                        "justification": res_parse(justification[11]),
                        "pages": extract_unique_page_numbers(justification[11]),
                    },
                    {
                        ...
                        "justification": res_parse(justification[12]),
                        "pages": extract_unique_page_numbers(justification[12]),
                    },
                ],
            },
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[13]),
                        "pages": extract_unique_page_numbers(justification[13]),
                    },
                    {
                        "ind": "Water and Effluents disclosure",
                        "gri": "GRI 303-1, GRI 303-2, GRI 303-3, GRI 303-4, GRI 303-5",
                        "assessment": comment[14],
                        "justification": res_parse(justification[14]),
                        "pages": extract_unique_page_numbers(justification[14]),
                    },
                    {
                        "ind": "GHG Emissions",
                        "gri": "GRI 305-1, GRI 305-2, GRI 305-4, GRI 305-5",
                        "assessment": comment[15],
                        "justification": res_parse(justification[15]),
                        "pages": extract_unique_page_numbers(justification[15]),
                    },
                    {
                        "ind": "Waste, e-waste related disclosure",
                        "gri": "GRI 306-3, GRI 306-4, GRI 306-5, GRI 306-2",
                        "assessment": comment[16],
                        "justification": res_parse(justification[16]),
                        "pages": extract_unique_page_numbers(justification[16]),
                    },
                    {
                        "ind": "Biodiversity",
                        "gri": "GRI 304-1",
                        "assessment": comment[17],
                        "justification": res_parse(justification[17]),
                        "pages": extract_unique_page_numbers(justification[17]),
                    },
                    {
                        "ind": "Environmental impact assessments",
                        "gri": "GRI 413-1, GRI 303-1",
                        "assessment": comment[18],
                        "justification": res_parse(justification[18]),
                        "pages": extract_unique_page_numbers(justification[18]),
                    },
                ],
            },
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[19]),
                        "pages": extract_unique_page_numbers(justification[19]),
                    },
                ],
            },
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[20]),
                        "pages": extract_unique_page_numbers(justification[20]),
                    },
                    {
                        "ind": "Input material procurement",
                        "gri": "GRI 204-1",
                        "assessment": comment[21],
                        "justification": res_parse(justification[21]),
                        "pages": extract_unique_page_numbers(justification[21]),
                    },
                ],
            },
            {
                ...
                "indicator_gri_and_assessment": [
                    {
                        ...
                        "justification": res_parse(justification[22]),
                        "pages": extract_unique_page_numbers(justification[22]),
                    },
                    {
                        "ind": "Marketing and Labeling",
                        "gri": "GRI 417",
                        "assessment": comment[23],
                        "justification": res_parse(justification[23]),
                        "pages": extract_unique_page_numbers(justification[23]),
                    },
                    {
                        "ind": "Customer Privacy",
                        "gri": "GRI 418",
                        "assessment": comment[24],
                        "justification": res_parse(justification[24]),
                        "pages": extract_unique_page_numbers(justification[24]),
                    },
                ],
            },
        ]
    ...
    if request.method == "POST" and "user_id" in request.POST:
        ...
        if os.path.exists(mapping_file_path):
            with open(mapping_file_path, "r") as mapping_file:
                ...
                if user_id in pdf_mappings:
                    contents = pdf_mappings[user_id]
...
def upload_pdf(request):
    if (
        ...
        file_path = os.path.join(public_dir, f"{pdf_id}_{pdf_file.name}.pdf")

        # Save the file
        with open(file_path, "wb+") as destination:
            for chunk in pdf_file.chunks():
                destination.write(chunk)
        pdf_file.name = pdf_file.name.split(".")[0]
        temp = f"{pdf_id}_{pdf_file.name}"
        # Construct the URL
        file_url = request.build_absolute_uri(f"/public/{temp}")
        ...
        if user_id in pdf_mappings:
            pdf_mappings[user_id][temp] = file_path
        else:
            pdf_mappings[user_id] = {temp: file_path}
    ...
    if request.method == "POST":
        ...
        with open(mapping_file_path, "r") as mapping_file:
            ...
            for id in pdf_ids:
                ...
                for top_key in data:
                    if id in data[top_key]:
                        uploaded_file = data[top_key][id]
                print(uploaded_file)
